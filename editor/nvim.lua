...
-- | referencing nvim-lua/kickstart.nvim
-- | ------------------------------------
...
-- clipboard settings { unnamedplus = sharing with OS }
		...
		config = function()
			...
			cmp.setup({
				...
				mapping = cmp.mapping.preset.insert({
					...
					-- key for selecting the suggestion
					["<C-y>"] = cmp.mapping.confirm({ select = true }),
					-- key to force execute snippet
